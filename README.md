...
> "Yumcha" is a play on Cantonese words. While it traditionally means "drinking tea" (<ruby>飲<rt>jɐm˧˥</rt>茶<rt>t͡sʰaː˩</rt>), it also sounds like a "phonological lookup" (<ruby>音<rt>jɐm˥</rt>查<rt>t͡sʰaː˩</rt>).
>
...
> [!NOTE]
> Custom schemes must conform to the language's underlying phonology. Otherwise, Yumcha will raise an exception when the scheme is added. Consult the `Language.phonology` property or the language's source files for the required phonemes and their underlying constraints. For bundled data, see the language's `phonology.tsv` in the [`/yumcha/data`](/yumcha/data) directory.
...
>
> Pre-generated syllable tables are available in the [`/docs/syllable_tables`](/docs/syllable_tables) directory. These tables are produced by `Exporter.export()` and can be useful for reviewing scheme coverage.
>
...
| Scheme name                                     | Author(s)                                                                             | Example (`t͡sʰɵn˧˥`) | Scheme ID         | Note                                                                                                                                                                                                          | Reference                                                                                                                                                                                                        |
| ----------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Braille                                         | _Unknown_                                                                             | `⠭⠎⠁`               | `braille`         |                                                                                                                                                                                                               | [World Braille Usage (3rd Edition) by UNESCO](https://web.archive.org/web/20140908010540/http://www.pharmabraille.com/LiteratureRetrieve.aspx?ID=122064)                                                         |
| Hangul                                          | [Dr. Wong Tak-sum](http://wongtaksum.no-ip.info:81)                                   | `츈〯`              | `hangul`          | 1) Display may vary depending on Unicode combining character support.<br/>2) Light rising and light departing tones are displayed using independent characters because Unicode lacks right-side tone markers. | [“訓民粵音”──以諺文書寫廣州話之嘗試](http://wongtaksum.no-ip.info:81/index.files/WOC-9_abs.pdf) ([Archive](http://web.archive.org/web/20230522125939/http://wongtaksum.no-ip.info:81/index.files/WOC-9_abs.pdf)) |
| Institute of Language in Education (ILE) Scheme | Fr. Thomas Yu Ping-chiu (allegedly); revised by the ILE                               | `tsoen2`            | `ile`             |                                                                                                                                                                                                               | [ILE romanization of Cantonese](https://en.wikipedia.org/wiki/ILE_romanization_of_Cantonese)                                                                                                                     |
| Jyutping                                        | The [Linguistic Society of Hong Kong](https://lshk.org/)                              | `ceon2`             | `jyutping`        |                                                                                                                                                                                                               | [Jyutping Cantonese Romanization Scheme](https://lshk.org/jyutping-scheme)                                                                                                                                       |
| Kuping                                          | [tommycs127](https://github.com/tommycs127)                                           | `tśeon35^2`         | `kuping`          |                                                                                                                                                                                                               |
| Kuping (Alternative)                            | tommycs127                                                                            | `ts'eon35^2`        | `kuping_alt`      | An alternative Kuping scheme designed for easier input.                                                                                                                                                       |
| Meyer–Wempe                                     | [Bernard F. Meyer](https://en.wikipedia.org/wiki/Bernard_F._Meyer), Theodore F. Wempe | `ts'ún`             | `meyer_wempe`     |                                                                                                                                                                                                               | [Meyer–Wempe](https://en.wikipedia.org/wiki/Meyer%E2%80%93Wempe)                                                                                                                                                 |
| Pênkyämp                                        | _Unknown_                                                                             | `cõnt`              | `penkyamp`        |                                                                                                                                                                                                               | [Penkyamp 方案](https://zh-yue.wikipedia.org/wiki/Penkyamp%E6%96%B9%E6%A1%88)                                                                                                                                    |
| Cantonese Transliteration Scheme                | The Guangdong Education department; revised by Rao Bing-cai                           | `cên2`              | `rao`             |                                                                                                                                                                                                               | [Cantonese Transliteration Scheme](https://en.wikipedia.org/wiki/Cantonese_Transliteration_Scheme)                                                                                                               |
| Sidney Lau                                      | [Sidney Lau Sek-cheung](https://en.wikipedia.org/wiki/Sidney_Lau)                     | `chun2`             | `sidneylau`       | Tone degree symbol is not superscripted.                                                                                                                                                                      | [Sidney Lau Cantonese Romanization System](https://sidneylau.com/en/sidney-lau-cantonese-romanization-system-pronunciation-guide-initials.htm)                                                                   |
| S. L. Wong (Romanization)                       | [Wong Shik-ling](https://en.wikipedia.org/wiki/Wong_Shik_Ling)                        | `ˊtsœn`             | `slwong_roman`    | Conventional numeral tone marking is not implemented.                                                                                                                                                         | [S. L. Wong (romanisation)](<https://en.wikipedia.org/wiki/S._L._Wong_(romanisation)>)                                                                                                                           |
| S. L. Wong (Phonetic)                           | Wong Shik-ling                                                                        | `ˊtseun`            | `slwong_phonetic` | Conventional numeral tone marking is not implemented.                                                                                                                                                         | [S. L. Wong (phonetic symbols)](<https://en.wikipedia.org/wiki/S._L._Wong_(phonetic_symbols)>)                                                                                                                   |
| Standard Romanization                           | John Chalmers                                                                         | `ts'ún`             | `standard`        |                                                                                                                                                                                                               | [Standard Romanization](https://en.wikipedia.org/wiki/Standard_Romanization)                                                                                                                                     |
| Yale                                            | Gerard P. Kok, Parker Po-fei Huang                                                    | `chéun`             | `yale`            |                                                                                                                                                                                                               | [Yale romanization of Cantonese](https://en.wikipedia.org/wiki/Yale_romanization_of_Cantonese)                                                                                                                   |
| Yựtyựt                                          | Sky Darmos                                                                            | `cởn`               | `yutyut`          |                                                                                                                                                                                                               | [Yựtyựt (越式粵拼)](https://www.omniglot.com/chinese/yutyu.htm)                                                                                                                                                  |
...
![Cantonese Progress](<https://img.shields.io/badge/Schemes-15%2F19_(79%25)-yellowgreen>)

- [x] Braille
- [x] Hangul
- [x] Cantonese Transliteration Scheme
