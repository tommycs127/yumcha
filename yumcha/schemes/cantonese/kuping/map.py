...
OBJECT_TO_NUCLEUS: to_string_map_type = {
    ...
    (VowelCloseness.OPEN_MID, VowelBackness.FRONT, True, False): "ö",
...
OBJECT_TO_TONE: to_string_map_type = {
    (CantoneseToneRegister.DARK, CantoneseToneName.LEVEL, None): "55^1",
    (CantoneseToneRegister.DARK, CantoneseToneName.LEVEL, "53"): "53^1",
    (CantoneseToneRegister.DARK, CantoneseToneName.RISING, None): "35^2",
    (CantoneseToneRegister.DARK, CantoneseToneName.DEPARTING, None): "33^3",
    (CantoneseToneRegister.DARK_UPPER, CantoneseToneName.ENTERING, None): "55^4",
    (CantoneseToneRegister.DARK_LOWER, CantoneseToneName.ENTERING, None): "33-4",
    (CantoneseToneRegister.LIGHT, CantoneseToneName.LEVEL, None): "11_1",
    (CantoneseToneRegister.LIGHT, CantoneseToneName.LEVEL, "21"): "21_1",
    (CantoneseToneRegister.LIGHT, CantoneseToneName.RISING, None): "13_2",
    (CantoneseToneRegister.LIGHT, CantoneseToneName.DEPARTING, None): "22_3",
    (CantoneseToneRegister.LIGHT, CantoneseToneName.ENTERING, None): "22_4",
}
